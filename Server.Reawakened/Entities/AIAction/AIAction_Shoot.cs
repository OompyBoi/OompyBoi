...
public class AI_Action_Shoot
{
    ...
    public AI_Action_Shoot(ref AIProcessData aiData, float startTime, int nbBulletsPerRound, float fireSpreadStartAngle, float fireSpreadAngle, int nbFireRounds, float delayBetweenBullets, float delayBetweenFireRound, float projectileSpeed, bool fireSpreadClockwise, float delayShot_Anim, bool lobTrajectory)
    {
        _currentFireRound = -1;
